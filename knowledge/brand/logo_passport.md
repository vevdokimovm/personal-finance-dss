...
- **Рабочий промпт — в разделе 7.** Это итог долгого подбора, бери его.
...
> Это итог долгого подбора (промпты #1→#2→#3→финал). Главные правки, которые довели до эталона: гашение реализма штурвала, 3 монетных элемента прямым текстом, чистый центр без спиц, чёрный фон с padding.
>
