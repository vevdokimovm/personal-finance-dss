...
**Честное чтение карты:** верх-право не пустой — рядом YNAB (прозрачный метод, но ручной) и Cleo (советует, но чёрный ящик). Но **связки «прескриптивная холистическая оптимизация (долг+резерв+цели) + показанная математика + прогноз»** не закрывает полностью ни один разобранный продукт (проверка 09.09.2026 по 41 источнику; формулировки — `docs/novelty_statement.md`). Это твой клин — реальный, но более узкий, чем в России.
...
| **Холистическая оптимизация долг/резерв/цели одним движком + прогноз** | 🟢 **относительно свободно** — целостно и прозрачно не делает ни один разобранный продукт; у Capital One задача раскрыта патентом US11023967B1, но не выпущена в продукт |
