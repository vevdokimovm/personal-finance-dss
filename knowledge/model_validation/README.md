...
| `joined_v5.csv.gz` | Раунд 5: модель v3.5.0 + четыре эксперта на датасете v5, 12 000 × 71. Приёмка fail-loud прошла у всех четверых без нарушений. Согласие 78.63% action-vector при попарном коридоре экспертов 58.18–79.99. Разбор — `docs/reports/testing/expert_certification_round5.md`, инструменты — `build_joined_v5.py`, `round5_agreement.py`, `expert_profiles_cross.py` |
