...
# как десятичный разделитель (правило 6 CLAUDE.md). Точка в «27.9%» читалась
...
CASE_META: dict[str, dict[str, str]] = {
    ...
    "dmitriy": {
        "n": "2",
        "name": "Дмитрий, 41",
        "role": "Senior IT · Санкт-Петербург",
        "tag": "Здоровый бюджет",
        "accent": "green",
    ...
    "ekaterina": {
        "n": "7",
        "name": "Екатерина, 34",
        "role": "Дизайнер на проектах · Москва",
    ...
    "natalya": {
        "n": "9",
        "name": "Наталья, 62",
        "role": "Пенсионерка с подработкой · Тверь",
