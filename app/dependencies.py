...
#
# 🔴 `/api/demo/load` и `/api/demo/clear` добавлены 08.09.2026. Они ПИШУТ, но пишут
# исключительно в демо-пул того же гостя и сами же его очищают — ради этого
# и существуют. Без них демо-песочница на проде была недостижима ВСЕМ СРАЗУ:
