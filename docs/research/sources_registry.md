# Реестр источников исследований вехи 8

Собрано 30–31.07.2026. Ссылки живут своей жизнью: при расхождении методички с источником
прав источник, а методичку надо пометить датой и поправить.

---

## 1. Модели, усилия, экономика токенов
...
## 2. Skills, Connectors, Plugins, Claude Design
...
## 3. Дизайн-язык финтехов РФ, числа, доступность, регуляторика
...
## 4. Архитектура React и производительность
...
## 5. Безопасность фронтенда и цепочка поставок
...
## 7. Контракт, тесты, токены дизайна, онбординг
...
## Заход 7 — агентский контур Claude Code (05.08.2026)
...
- https://github.com/anthropics/claude-code/issues/19134
- https://github.com/anthropics/claude-code/issues/12836
- https://github.com/ColeMurray/claude-code-otel
- https://github.com/lasswellt/cc-metrics
- https://github.com/disler/claude-code-hooks-mastery
- https://www.piax.org/skills/anthropics-skills/mcp-builder
...
- https://www.mintmcp.com/blog/claude-code-hooks-security
...
- https://www.epam.com/insights/ai/blogs/ai-agent-failure-modes-enterprise
...
- https://computingforgeeks.com/claude-code-hooks-guide/
...
- https://pydevtools.com/handbook/how-to/how-to-configure-claude-code-to-use-virtual-environments/
...
- https://claudefa.st/blog/guide/mechanics/claude-5-context-engineering
- https://aidailycheck.com/claude/guide/prompting-claude-5-models
- https://www.mager.co/blog/2026-07-24-context-engineering-claude-5/
- https://explainx.ai/blog/steering-claude-code-claude-md-skills-hooks-subagents-rules-2026
- https://konadu.dev/how-claude-code-loads-claude-rules
- https://www.groff.dev/blog/claude-rules-vs-claude-md
...
- https://wmedia.es/en/tips/claude-code-context-command-token-usage
...
- https://dev.to/gabrielanhaia/anthropic-prompt-caching-saves-90-heres-the-one-caveat-nobody-mentions-258k
- https://www.developersdigest.tech/blog/prompt-caching-claude-api-production-guide
- https://scottspence.com/posts/measuring-claude-code-skill-activation-with-sandboxed-evals
- https://www.nathanonn.com/claude-code-skill-creator-guide/
- https://medium.com/@karkeralathesh/the-complete-guide-to-testing-claude-code-skills-with-the-skill-creator-1ae3821bd7b8
