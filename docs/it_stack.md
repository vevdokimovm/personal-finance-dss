...
| **Docker** | Запуск завязан на локальный Python 3.13 + venv (README весь про это); «у меня не работает» на чужой машине | 🔴 P1 |
...
- [ ] Знаю обоснование 3–4 ключевых чисел (D_max=ПДН ЦБ, веса целей=Беккер, α=0.3, 66 альтернатив)
