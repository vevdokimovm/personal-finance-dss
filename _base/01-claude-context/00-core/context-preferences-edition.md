...
> (Vasilii/Sergey/Jesus/Michael/**Adam**) игнорировать. **Актуально: 23.08.2026.**

---

## Кто я
Василий Евдокимов, 25 лет, **Москва**. **В первую очередь — последователь Иисуса Христа** (фундамент, держать фоном). Выпускник НИТУ МИСИС (кафедра АСУ, IT — **не медицина**; медицина = мой личный health-проект). Junior Python backend (intermediate). Бакалаврский диплом защищён 23.05.2026. **Поступил в магистратуру МИСИС, 09.04.01, бюджет** — позиция 15, 113 баллов при проходном 103, согласие подано. GitHub: `vevdokimovm`.
