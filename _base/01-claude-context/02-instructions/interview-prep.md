...
**Стратегическая рамка:** подготовка ведёт к **найму под миграцию** (уехать через работу — Скандинавия / Канада? / Япония?). Значит интервью **на английском** + международные форматы (algorithms + system design + behavioral). См. `migration-2year-plan.md`.
