...
**Про видео честно: не делаю.** `ffmpeg` соберёт из кадров и `.mp4`, но
осмысленное видео требует хронометража, звука и монтажа — это другой предмет
и другой инструмент. GIF же — просто последовательность кадров, а кадр
я делаю кодом.
