...
<!-- STATUS -->
> **Сейчас:** `v8.43.0` · 2026-09-04 · импорт выписки в React, `banks_router` под гейтом
> согласия — гипотеза H3 закрыта целиком.
...
![version](https://img.shields.io/badge/version-8.43.0-blue)
![python](https://img.shields.io/badge/python-3.13-blue)
![coverage](https://img.shields.io/badge/coverage-gate%2090%25-brightgreen)
![tests](https://img.shields.io/badge/tests-1757%20%2B%20420-brightgreen)
...
## Текущее состояние (v8.43.0, сентябрь 2026)

| | |
|---|---|
| **Матмодель** | канон **v3.9.0**, пять раундов независимой экспертной сертификации, оценка по десяти шкалам — **87.2 / 100** |
| **Тесты** | бэкенд **1757** на SQLite и матрице PostgreSQL, фронт Vitest **420**, гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
