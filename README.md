...
<!-- STATUS -->
> **Сейчас:** `v9.13.20` · 2026-09-24 · веха 9 открыта, синтез корпуса завершён (12 документов из 12), идёт предподготовка к деплою.
...
[![CI](https://github.com/vevdokimovm/personal-finance-dss/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/vevdokimovm/personal-finance-dss/actions/workflows/ci.yml?query=branch%3Amain)
...
![version](https://img.shields.io/badge/version-9.13.20-blue)
...
## Текущее состояние (v9.13.20, сентябрь 2026)
