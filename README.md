...
<!-- STATUS -->
> **Сейчас:** `v9.0.0` · 2026-09-05 · веха 9 открыта, идёт предподготовка к деплою:
> rate-limit за прокси, второй фактор на экране входа, ревизия перед запуском.
...
## Текущее состояние (v9.0.0, сентябрь 2026)

| | |
|---|---|
| **Матмодель** | канон **v3.9.0**, пять раундов независимой экспертной сертификации, оценка по десяти шкалам — **87.2 / 100** |
| **Тесты** | бэкенд **1949** на SQLite и матрице PostgreSQL, фронт Vitest **529**, e2e **201** в трёх браузерах (Chromium, Firefox, WebKit), axe-core **24** (две темы), гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
