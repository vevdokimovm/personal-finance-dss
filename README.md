...
![version](https://img.shields.io/badge/version-8.31.1-blue)
...
## Текущее состояние (v8.31.1, сентябрь 2026)

| | |
|---|---|
| **Матмодель** | канон **v3.9.0**, пять раундов независимой экспертной сертификации, оценка по десяти шкалам — **87.2 / 100** |
| **Тесты** | бэкенд **1636** на SQLite и матрице PostgreSQL, фронт Vitest **256**, гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
