...
![version](https://img.shields.io/badge/version-8.37.0-blue)
...
## Текущее состояние (v8.37.0, сентябрь 2026)

| | |
|---|---|
| **Матмодель** | канон **v3.9.0**, пять раундов независимой экспертной сертификации, оценка по десяти шкалам — **87.2 / 100** |
| **Тесты** | бэкенд **1694** на SQLite и матрице PostgreSQL, фронт Vitest **360**, гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
