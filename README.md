...
| **Тесты** | бэкенд **1762** на SQLite и матрице PostgreSQL, фронт Vitest **454**, e2e **201** в трёх браузерах (Chromium, Firefox, WebKit), axe-core **24** (две темы), гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
