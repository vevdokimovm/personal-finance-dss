...
| **Тесты** | бэкенд **1850** на SQLite и матрице PostgreSQL, фронт Vitest **492**, e2e **201** в трёх браузерах (Chromium, Firefox, WebKit), axe-core **24** (две темы), гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
