...
<!-- STATUS -->
> **Сейчас:** `v8.54.0` · 2026-09-05 · советы по расходам вышли из API на экран:
> §8.2 «вынести на фронт всё, что висит только в API» закрыт.
...
![version](https://img.shields.io/badge/version-8.54.0-blue)
...
## Текущее состояние (v8.54.0, сентябрь 2026)

| | |
|---|---|
| **Матмодель** | канон **v3.9.0**, пять раундов независимой экспертной сертификации, оценка по десяти шкалам — **87.2 / 100** |
| **Тесты** | бэкенд **1866** на SQLite и матрице PostgreSQL, фронт Vitest **510**, e2e **201** в трёх браузерах (Chromium, Firefox, WebKit), axe-core **24** (две темы), гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
