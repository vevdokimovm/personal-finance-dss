...
<!-- STATUS -->
> **Сейчас:** `v8.45.0` · 2026-09-04 · фронт вехи 8 впервые отдаётся сервером —
> до этого React работал только в dev.
...
![version](https://img.shields.io/badge/version-8.45.0-blue)
![python](https://img.shields.io/badge/python-3.13-blue)
![coverage](https://img.shields.io/badge/coverage-gate%2090%25-brightgreen)
![tests](https://img.shields.io/badge/tests-1734%20%2B%20438-brightgreen)
...
## Текущее состояние (v8.45.0, сентябрь 2026)

| | |
|---|---|
| **Матмодель** | канон **v3.9.0**, пять раундов независимой экспертной сертификации, оценка по десяти шкалам — **87.2 / 100** |
| **Тесты** | бэкенд **1734** на SQLite и матрице PostgreSQL, фронт Vitest **438**, e2e **189** в трёх браузерах (Chromium, Firefox, WebKit), axe-core **24** (две темы), гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
