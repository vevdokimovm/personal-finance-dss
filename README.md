...
<!-- STATUS -->
> **Сейчас:** `v9.13.8` · 2026-09-24 · веха 9 открыта, синтез корпуса завершён (12 документов из 12), идёт предподготовка к деплою.
...
![version](https://img.shields.io/badge/version-9.13.8-blue)
...
## Текущее состояние (v9.13.8, сентябрь 2026)
