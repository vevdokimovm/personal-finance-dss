...
<!-- STATUS -->
> **Сейчас:** `v8.49.0` · 2026-09-05 · §8.2 «ГЛАВНОЕ» закрыт целиком: результаты
> A/B-экспериментов на фронте, и экран говорит, можно ли верить разнице.
...
![version](https://img.shields.io/badge/version-8.49.0-blue)
...
## Текущее состояние (v8.49.0, сентябрь 2026)

| | |
|---|---|
| **Матмодель** | канон **v3.9.0**, пять раундов независимой экспертной сертификации, оценка по десяти шкалам — **87.2 / 100** |
| **Тесты** | бэкенд **1834** на SQLite и матрице PostgreSQL, фронт Vitest **477**, e2e **201** в трёх браузерах (Chromium, Firefox, WebKit), axe-core **24** (две темы), гейт покрытия 90%, flake8 = 0, ревизионный гейт docs↔code |
