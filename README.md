...
![version](https://img.shields.io/badge/version-4.16.36-blue)
...
### v2.x — продуктовое дозревание (single-user)
...
### v3.0.0 — международный / многопользовательский режим (MAJOR)
...
### v4.x — production-hardening (текущая эпоха)
...
> Подробная история по каждой версии — в [`CHANGELOG.md`](CHANGELOG.md). «Где мы сейчас» и
> резюме точки разработки — в [`docs/WATCHLOG.md`](docs/WATCHLOG.md).
